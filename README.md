...
curl -fsSL https://raw.githubusercontent.com/colinricardo/opencode/refs/heads/main/install | bash

# Install a specific version
curl -fsSL https://raw.githubusercontent.com/colinricardo/opencode/refs/heads/main/install | VERSION=0.1.0 bash
```

### Using Homebrew (macOS and Linux)

```bash
brew install colinricardo/tap/opencode
```
...
```bash
# Using yay
yay -S colinricardo-bin

# Using paru
paru -S colinricardo-bin
```

### Using Go

```bash
go install github.com/colinricardo/opencode@latest
```
...
git clone https://github.com/colinricardo/opencode.git
cd opencode
